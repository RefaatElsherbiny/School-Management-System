...
@section('content')
        ...
        <div class="row">
             <div class="col-md-12 mb-30">
                ...
                <div class="acd-group">
                    <a href="#" class="acd-heading">{{ $Grade->name_grades }}</a>
                    <div class="acd-des">
                ...
                <form action="{{ route('sections.store') }}" method="POST">
                    ...
                    <div class="col">
                        ...
                        <select name="Grade_id" class="custom-select"
                            ...
                            @foreach ($list_Grades as $list_Grade)
                                <option value="{{ $list_Grade->id }}"> {{ $list_Grade->name_grades }}
                                </option>
                            @endforeach
                        </select>
                    </div>
...
var go = $('select[name="Class_id"]').append('<option value="' +
key + '">' + value + '</option>');
