        ...
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                ...
                <a class="navbar-brand brand-logo"
                 ...
                 <img style="width: 200px; height:47px" src="{{ URL::asset('assets/images/admin1.jpg') }}" alt="">

                 @elseif(Auth::guard('student')->check())

                 <img style="width: 160px; height:57px" src="{{ URL::asset('assets/images/student.png') }}" alt="">
                ...
                <a class="navbar-brand brand-logo-mini"
                 ...
                 <img src="{{ URL::asset('assets/images/logo-icon-dark.png') }}"
            ...
            @endforeach
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{ URL::asset('assets/images/1.PNG') }}" alt="avatar">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form action="{{ route('logout','student') }}" method="GET" >

                        @elseif(auth('teacher')->check())
                        <form action="{{ route('logout','teacher') }}" method="GET" >

                            @elseif(auth('parent')->check())
                            <form action="{{ route('logout','parent') }}" method="GET" >
