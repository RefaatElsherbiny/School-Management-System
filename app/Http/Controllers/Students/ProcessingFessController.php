...
use App\Repository\Processing_FessRepositoryInterface;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

class ProcessingFessController extends Controller
{
    protected $Processing;

    public function __construct(Processing_FessRepositoryInterface $Processing)
    {
