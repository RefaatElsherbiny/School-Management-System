...
class CreatePromotionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('promotions', function (Blueprint $table) {
            ...
            $table->foreign('from_Classroom')->references('id')->on('class_room')->onDelete('cascade');
            $table->foreign('from_section')->references('id')->on('create_sections')->onDelete('cascade');

            $table->foreign('to_grade')->references('id')->on('grades')->onDelete('cascade');
            $table->foreign('to_Classroom')->references('id')->on('class_room')->onDelete('cascade');
            $table->foreign('to_section')->references('id')->on('create_sections')->onDelete('cascade');
        });
    }
